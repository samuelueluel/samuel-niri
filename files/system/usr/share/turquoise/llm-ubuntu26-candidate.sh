...
RUNTIME_IMAGE="${RUNTIME_IMAGE:-localhost/lemonade-server:ubuntu26-next-candidate}"
...
SOURCE_RECIPE_VOLUME="${SOURCE_RECIPE_VOLUME:-lemonade26-v108-recipe}"
SOURCE_CACHE_VOLUME="${SOURCE_CACHE_VOLUME:-lemonade26-v108-cache}"
PORT="${PORT:-13310}"
JOBS="${JOBS:-64}"
