...
echo "  - Vivaldi profiles (Preferences / contextmenu.json) — copy from Dropbox:"
echo "    ~/Dropbox/Linux_Config_Backup/EndeavourOS/vivaldi/{casual,work,llm}/"
echo "  - Vivaldi launchers: fix Exec= lines for Flatpak (see SETUP.md for sed command)"
echo "  - Wallpapers — copy from Dropbox: ~/Dropbox/Linux_Config_Backup/EndeavourOS/Wallpapers/"
